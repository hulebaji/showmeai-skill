...
|---|---|
| `gemini-3.1-flash-image` | `image_size`: 0.5K/1K/2K/4K; `aspect_ratio`: 1:1, 2:3, 3:2, 3:4, 4:3, 4:5, 5:4, 9:16, 16:9, 21:9; no native `n` parameter |
| `gemini-3-pro-image` | `image_size`: 1K/2K/4K; the same aspect-ratio set |
